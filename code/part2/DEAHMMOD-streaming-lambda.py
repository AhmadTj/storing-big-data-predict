...
def lambda_handler(event, context):
    ...
    __TableName__ = 'DEAHMMOD-streaming-dynamodb' # <-- Insert your table name
    # Configure Firehose service as part of Step 6
    firehose_name = 'deahmmod-deliverystream' # <-- Insert your Firehose name
    # ===================================================================================
    ...
    try:
        ...
        # ===================== STUDENT INPUT REQUIRED ======================================
        firehose_client.put_record_batch(DeliveryStreamName=firehose_name, Records=batch)
        # ===================================================================================
